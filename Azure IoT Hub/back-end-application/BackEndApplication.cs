...
namespace back_end_application
{
    class BackEndApplication
    {
        ...
        private readonly static string s_connectionString = "HostName=wilink.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=N0A21SvBOz9kuId/etJpA9UDLOf8F2Ol1XBobhKw0vI=";
        ...
        private static async Task InvokeMethod()
        {
            ...
            var response = await s_serviceClient.InvokeDeviceMethodAsync("Device1", methodInvocation);
